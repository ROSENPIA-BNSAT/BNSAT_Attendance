...
<!-- Include PHP Email Form Validation -->
<script src="assets/vendor/php-email-form/validate.js"></script>

<!-- Include venobox JavaScript -->
<script src="assets/vendor/venobox/venobox.min.js"></script>

<!-- Include jQuery Waypoints -->
...
<!-- Include jquery.datetimepicker JavaScript -->
<script type="text/javascript" src="assets/js/jquery.datetimepicker.full.min.js"></script>

<!-- Include font-awesome JavaScript -->
<script type="text/javascript" src="assets/fontawesome-free-6.4.2-web/js/all.js"></script>

<!-- Include jquery-te-1.4.0 JavaScript -->
